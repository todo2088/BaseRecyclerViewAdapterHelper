...
public class DragSelectTouchListener implements RecyclerView.OnItemTouchListener {
    ...
    private void updateSelectedRange(@NonNull androidx.recyclerview.widget.RecyclerView rv, MotionEvent e) {
        updateSelectedRange(rv, e.getX(), e.getY());
    }

    private void updateSelectedRange(androidx.recyclerview.widget.RecyclerView rv, float x, float y) {
