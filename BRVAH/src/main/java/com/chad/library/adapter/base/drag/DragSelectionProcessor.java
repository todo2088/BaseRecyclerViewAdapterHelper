package com.chad.library.adapter.base.drag;
        ...
        switch (mMode) {
            ...
            case ToggleAndUndo: {
                for (int i = start; i <= end; i++)
                    checkedUpdateSelection(i, i, isSelected != (mOriginalSelection != null && mOriginalSelection.contains(i)));
                break;
            }
            case FirstItemDependent: {
            ...
            case FirstItemDependentToggleAndUndo: {
                ...
                for (int i = start; i <= end; i++)
                    checkedUpdateSelection(i, i, isSelected ? !mFirstWasSelected : mOriginalSelection != null && mOriginalSelection.contains(i));
                break;
            }
        }
    }
