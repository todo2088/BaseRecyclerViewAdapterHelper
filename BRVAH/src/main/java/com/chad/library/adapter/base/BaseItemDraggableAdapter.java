...
public abstract class BaseItemDraggableAdapter<T, K extends BaseViewHolder> extends BaseQuickAdapter<T, K> {
    ...
    public int getViewHolderPosition(@NonNull androidx.recyclerview.widget.RecyclerView.ViewHolder viewHolder) {
        return viewHolder.getAdapterPosition() - getHeaderLayoutCount();
    }

    public void onItemDragStart(@NonNull androidx.recyclerview.widget.RecyclerView.ViewHolder viewHolder) {
    ...
    public void onItemDragMoving(@NonNull androidx.recyclerview.widget.RecyclerView.ViewHolder source, @NonNull androidx.recyclerview.widget.RecyclerView.ViewHolder target) {
    ...
    public void onItemDragEnd(@NonNull androidx.recyclerview.widget.RecyclerView.ViewHolder viewHolder) {
        if (mOnItemDragListener != null && itemDragEnabled) {
    ...
    public void onItemSwipeStart(@NonNull androidx.recyclerview.widget.RecyclerView.ViewHolder viewHolder) {
    ...
    public void onItemSwipeClear(@NonNull androidx.recyclerview.widget.RecyclerView.ViewHolder viewHolder) {
        if (mOnItemSwipeListener != null && itemSwipeEnabled) {
            mOnItemSwipeListener.clearView(viewHolder, getViewHolderPosition(viewHolder));
        }
    }

    public void onItemSwiped(@NonNull androidx.recyclerview.widget.RecyclerView.ViewHolder viewHolder) {
    ...
    public void onItemSwiping(Canvas canvas, androidx.recyclerview.widget.RecyclerView.ViewHolder viewHolder, float dX, float dY, boolean isCurrentlyActive) {
        if (mOnItemSwipeListener != null && itemSwipeEnabled) {
