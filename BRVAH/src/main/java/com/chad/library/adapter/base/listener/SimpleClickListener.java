...
//                mPressedView.setPressed(true);
        ...
        ItemTouchHelperGestureListener(androidx.recyclerview.widget.RecyclerView recyclerView) {
        ...
        private void resetPressedView(@Nullable final View pressedView) {
            if (pressedView != null) {
                pressedView.postDelayed(new Runnable() {
                    @Override
                    public void run() {
                        if (pressedView != null&&pressedView.isPressed()) {
    ...
    private void setPressViewHotSpot(@NonNull final MotionEvent e, @Nullable final View mPressedView) {
    ...
    public boolean inRangeOfView(@Nullable View view, @NonNull MotionEvent ev) {
