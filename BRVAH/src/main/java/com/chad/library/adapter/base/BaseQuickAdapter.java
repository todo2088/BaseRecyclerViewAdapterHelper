...
public abstract class BaseQuickAdapter<T, K extends BaseViewHolder> extends RecyclerView.Adapter<K> {
    ...
    public void setOnLoadMoreListener(RequestLoadMoreListener requestLoadMoreListener, androidx.recyclerview.widget.RecyclerView recyclerView) {
        openLoadMore(requestLoadMoreListener);
        if (getRecyclerView() == null) {
            setRecyclerView(recyclerView);
        }
     ...
     * @see #setNewData(List)
     */
    public void disableLoadMoreIfNotFullPage(@Nullable androidx.recyclerview.widget.RecyclerView recyclerView) {
    ...
    private boolean isFullScreen(androidx.recyclerview.widget.LinearLayoutManager llm) {
        return (llm.findLastCompletelyVisibleItemPosition() + 1) != getItemCount() ||
                llm.findFirstCompletelyVisibleItemPosition() != 0;
    }

    private int getTheBiggestNumber(@Nullable int[] numbers) {
        int tmp = -1;
     ...
     */
    protected void setFullSpan(@NonNull androidx.recyclerview.widget.RecyclerView.ViewHolder holder) {
    ...
    @Override
    public void onAttachedToRecyclerView(@NonNull final androidx.recyclerview.widget.RecyclerView recyclerView) {
    ...
    public interface SpanSizeLookup {
        int getSpanSize(androidx.recyclerview.widget.GridLayoutManager gridLayoutManager, int position);
    }
    ...
    private void bindViewClickListener(@Nullable final BaseViewHolder baseViewHolder) {
     ...
     *               the effect of this method is the same as that of {@link #addHeaderView(View)}.
     */
    public int addHeaderView(@NonNull View header, int index) {
     ...
     * @param orientation
     */
    public int addHeaderView(@NonNull View header, int index, int orientation) {
    ...
    public int setHeaderView(@NonNull View header, int index) {
        return setHeaderView(header, index, LinearLayout.VERTICAL);
    }

    public int setHeaderView(@NonNull View header, int index, int orientation) {
    ...
    public int addFooterView(@NonNull View footer, int index) {
     ...
     *               the effect of this method is the same as that of {@link #addFooterView(View)}.
     */
    public int addFooterView(@NonNull View footer, int index, int orientation) {
    ...
    public int setFooterView(@NonNull View footer) {
        return setFooterView(footer, 0, LinearLayout.VERTICAL);
    }

    public int setFooterView(@NonNull View footer, int index) {
        return setFooterView(footer, index, LinearLayout.VERTICAL);
    }

    public int setFooterView(@NonNull View footer, int index, int orientation) {
     ...
     * @param holder
     */
    private void addAnimation(@NonNull androidx.recyclerview.widget.RecyclerView.ViewHolder holder) {
    ...
    @Nullable
    public View getViewByPosition(@Nullable androidx.recyclerview.widget.RecyclerView recyclerView, int position, @IdRes int viewId) {
...
//            subItemCount += list.size();
    ...
    private int getItemPosition(@Nullable T item) {
        return item != null && mData != null && !mData.isEmpty() ? mData.indexOf(item) : -1;
    }

    private boolean hasSubItems(@Nullable IExpandable item) {
        if (item == null) {
            return false;
        }
