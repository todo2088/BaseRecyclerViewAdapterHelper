 ...
 *       app:layout_swipeItemType="main"
 * <resources>
 * <declare-styleable name="SwipeItemLayout.Layout">
 * <attr name="layout_swipeItemType">
...
public class SwipeItemLayout extends ViewGroup {
    ...
    public static class LayoutParams extends MarginLayoutParams {
        ...
        public LayoutParams(@NonNull Context c, AttributeSet attrs) {
            ...
            itemType = a.getInt(R.styleable.SwipeItemLayout_Layout_layout_swipeItemType, -1);
            a.recycle();
        }
    ...
    public static class OnSwipeItemTouchListener implements RecyclerView.OnItemTouchListener {
        ...
        @Override
        public boolean onInterceptTouchEvent(@NonNull androidx.recyclerview.widget.RecyclerView rv, @NonNull MotionEvent ev) {
            ...
            switch (action) {
                ...
                case MotionEvent.ACTION_MOVE: {
                    ...
                    int deltaX = (int) ((x - lastMotionX) + 0.5);
                    int deltaY = (int) ((y - lastMotionY) + 0.5);
        ...
        @Override
        public void onTouchEvent(androidx.recyclerview.widget.RecyclerView rv, @NonNull MotionEvent ev) {
            if (ignoreActions)
                return;
